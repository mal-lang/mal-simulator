...
Usage:
    python scripts/get_dynamal_test_langs.py
"""
...
example_langs_dir = Path('tests') / 'testdata' / 'langs' / 'dynamal_example_langs'
example_langs_dir.mkdir(exist_ok=True)
...
def copy_test_langs(dir_name: str, repo_dir: Path) -> None:
    sub_dir = example_langs_dir / dir_name
