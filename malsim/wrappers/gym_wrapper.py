...
class DefenderEnv(gym.Env):
    ...
    def __init__(self, scenario_file, **kwargs) -> None:
        ...
        self.sim = MalSimulator(ag, **kwargs)

        self.defender_agent = TrainingAgent("defender", self.sim)
        self.observation_space = \
            self.defender_agent.observation_space(self.defender_agent.name)
        self.action_space = \
            self.defender_agent.action_space(self.defender_agent.name)
    ...
    def reset(
        ...
        return self.defender_agent.observation, {}
    ...
    @property
    def num_assets(self):
        return len(self.defender_agent._index_to_asset_type)

    @property
    def num_step_names(self):
        return len(self.defender_agent._index_to_step_name)
