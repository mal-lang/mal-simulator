...
class MalSimulator():
    ...
    def step(
        ...
        step_all_compromised_nodes: set[AttackGraphNode] = set()
        step_agent_compromised_nodes: dict[str, set] = {}
        ...
        for attacker_state in self._get_attacker_agents():
            ...
            step_agent_compromised_nodes[attacker_state.name] = agent_compromised
        ...
        for agent_name in self._alive_agents.copy():
            ...
            if isinstance(agent_state, MalSimAttackerState):
                self._update_attacker_state(
                    agent_state,
                    step_agent_compromised_nodes.get(agent_name, set()),
                ...
                raise TypeError(
                    f"Unknown agent class {agent_state.__class__}"
                )
