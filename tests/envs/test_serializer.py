...
def test_serializer() -> None:
    ...
    assert len(assoc_values) == len(set(assoc_values)), (
        'association_type integer values are not unique'
    )
    assert all(isinstance(v, int) for v in assoc_values), (
    ...
    assert len(attack_step_values) == len(set(attack_step_values)), (
        'attack_step_type integer values are not unique'
    )
    assert all(isinstance(v, int) for v in attack_step_values), (
    ...
    assert len(attack_step_class_values) == len(set(attack_step_class_values)), (
        'attack_step_class integer values are not unique'
    )
    assert all(isinstance(v, int) for v in attack_step_class_values), (
    ...
    assert all(isinstance(v, int) for v in tag_values), (
